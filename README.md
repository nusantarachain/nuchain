...
```bash
rustup default nightly-2021-07-15
rustup target add wasm32-unknown-unknown --toolchain nightly-2021-07-15
```

**CATATAN**: Pada contoh di atas menggunakan Rust versi nightly build 2021-07-15 karena telah teruji bisa melakukan kompilasi dengan lancar, namun ini hanya sebagai contoh apabila pada kemudian hari ada perubahan di Rust nightly yang membuat kode Nuchain tidak lagi bisa dikompilasi (tidak kompatibel) maka bisa coba update ke latest nightly.
