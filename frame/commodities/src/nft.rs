...
//!
//! This abstraction is implemented by [pallet_nft::Module](../struct.Module.html).
...
pub trait UniqueAssets<AccountId> {
    ...
    fn get_total_for_account(account: &AccountId) -> u64;
    /// The set of unique assets owned by an account.
    fn get_assets_for_account(account: &AccountId) -> Vec<(Self::AssetId, Self::AssetInfo)>;
    /// The ID of the account that owns an asset.
    fn get_owner_of(asset_id: &Self::AssetId) -> Option<AccountId>;
