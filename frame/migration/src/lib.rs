//! # Pallet for state migration
//!
//! This pallet provides functionality for migrating chain state from one chain to another.
//! 
//! Based on Centrifuge pallet-migration-manager.
//!
