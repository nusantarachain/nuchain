...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Migration: pallet_migration::{Pallet, Call, Storage, Event<T>},
	}
);
...
impl pallet_migration::Config for MockRuntime {
...
pub(crate) fn reward_events() -> Vec<pallet_migration::Event<MockRuntime>> {
	System::events()
		.into_iter()
		.map(|r| r.event)
		.filter_map(|e| {
