...
//     }
//     parameter_types! {
//         pub const MinDelegateNameLength: usize = 3;
//         pub const MaxDelegateNameLength: usize = 16;
//     }
//     ord_parameter_types! {
//         pub const One: u64 = 1;
//     }
...
//         type MinDelegateNameLength = MinDelegateNameLength;
//         type MaxDelegateNameLength = MaxDelegateNameLength;
...
//     #[test]
//     fn force_origin_able_to_create_delegate_of() {
//         new_test_ext().execute_with(|| {
//             assert_ok!(Did::create_delegate(Origin::signed(1), b"ORG1".to_vec(), 2));
//         });
//     }

//     #[test]
//     fn non_force_origin_cannot_create_delegate_of() {
//         new_test_ext().execute_with(|| {
//             assert_noop!(
//                 Did::create_delegate(Origin::signed(2), b"ORG1".to_vec(), 2),
