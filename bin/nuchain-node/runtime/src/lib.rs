...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("nuchain"),
	impl_name: create_runtime_str!("nuchain-gama2"),
...
parameter_types! {
	...
	pub const BondingDuration: sp_staking::EraIndex = 30;
...
impl_runtime_apis! {
    ...
    impl pallet_did_runtime_api::DidApi<Block, AccountId> for Runtime {
