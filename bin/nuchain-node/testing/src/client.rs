...
//! Utilities to build a `TestClient` for `nuchain-runtime`.
...
/// Call executor for `nuchain-runtime` `TestClient`.
...
pub type Client = client::Client<
	...
	nuchain_runtime::RuntimeApi,
>;

/// Transaction for nuchain-runtime.
