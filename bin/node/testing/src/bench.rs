				...
				function: match self.content.block_type {
					BlockType::RandomTransfersKeepAlive =>
						Call::Balances(BalancesCall::transfer_keep_alive {
							...
							value: nuchain_runtime::ExistentialDeposit::get() + 1,
						}),
					BlockType::RandomTransfersReaping => {
						Call::Balances(BalancesCall::transfer {
							...
							value: 100 * DOLLARS - (nuchain_runtime::ExistentialDeposit::get() - 1),
						})
					},
...
impl BenchKeyring {
	...
	pub fn generate_genesis(&self) -> nuchain_runtime::GenesisConfig {
		crate::genesis::config_endowed(
			Some(nuchain_runtime::wasm_binary_unwrap()),
